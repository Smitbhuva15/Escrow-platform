            ...
            <div className='mt-36 text-white flex items-center rounded-xl w-full'>
                <div className=''>
                    ...
                    <div className=' md:w-[90%] lg:text-[18px] text-sm pt-5 leading-6 text-gray-300'>
                        ...
                        <p className='pb-6'>If a dispute arises, the arbiter gets the unencrypted text of the contract from the claimant in order to be able to resolve the dispute. The arbiter is bound by their <span className='text-[#8f614c]'>own privacy terms</span>.</p>
                        <p className='pb-6'>
                ...
                <div className='mb-24 mt-16  text-white flex items-center rounded-xl w-full'>
                    <div className='md:w-2/3'>
                        ...
                        <div className='md:hidden block  justify-items-center   '>
                            <Image src={'/custody.png'} alt='custody' width={300} height={400} className='sm:h-72 sm:w-72 h-52 w-52' />
                        </div>
                        <div className=' md:w-[90%] lg:text-[18px] text-sm pt-5 leading-6 text-gray-300'>
                            <p className='pb-6'>Neither the Escryn nor the arbiters custody the funds. The funds are escrowed by a smart contract deployed on a <span className='text-[#8f614c]'>decentralized network</span>, and no third party can touch them, even the Escryn.</p>
                    ...
                    <div className='md:w-1/3 md:block hidden justify-items-center md:mt-10 mt-8 '>
                        <Image src={'/custody.png'} alt='custody' width={300} height={400} className='h-72 w-72' />
                    </div>
                </div>
            </div>
