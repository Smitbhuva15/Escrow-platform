    ...
    return (
        <div>
            ...
            <div >
                ...
                View all your deals
                <Link href={'/dashboard'} className='text-[#1d45fe] hover:cursor-pointer'> here</Link>  including those you’ve created in the past and those currently active, with detailed status updates to track every stage of each transaction on Escrow.
            ...
            <div >
                ...
                <Link href={'/dashboard'} className='text-[#1d45fe] hover:cursor-pointer'> here,</Link>   and once a dispute is resolved, unlock your staked funds directly from the Escrow platform.
            ...
            <div >
                ...
                <Link href={'/dashboard'} className='text-[#1d45fe] hover:cursor-pointer'> here,</Link>  to track every transaction, monitor your ETH movements, and stay informed about your participation on the Escrow.
